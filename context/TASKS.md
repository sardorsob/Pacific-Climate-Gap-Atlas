...
- Functional notes: Review the owner-approved working spine: Act I, a region moving in different directions; Act II, a region seen with unequal clarity; coda, release into the existing island-by-island explorer. Write the one-sentence problem, claim chain, regional evidence, illustrative place labels, visual operations, action/decision value, caveats, and rejection risks inside existing context files. The review may revise or reject the working spine. Individual islands may illustrate a regional pattern but may not become the product scope. Do not create a standalone concept file.
...
- Attempts: 0
- Max attempts: 3
- Attempt log: Renumbered from the former TASK-068 before work began. 2026-07-14: Owner approved the regional two-act direction as the working hypothesis, not the final evidence contract; TASK-068 must test it before this selection gate begins.
- Status: pending
