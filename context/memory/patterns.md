...
- `TASK-028` story/copy rewrite and `TASK-027` final visual/interactions polish are complete. Future app changes still need Codex QA for claims, caveats, accessibility, and commits.
