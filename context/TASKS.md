...
- Attempts: 0
- Max attempts: 3
- Attempt log: Created by TASK-071 as the single closing gate. It has no planned production-code ownership.
- Status: pending
