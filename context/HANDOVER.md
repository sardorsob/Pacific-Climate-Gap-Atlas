...
1. Codex should QA `TASK-032` before committing any Fable visual pass work.
2. Fable is a good fit for the `TASK-033` copy fix, `TASK-035` island-anchoring design, and `TASK-036` detail-panel redesign; Codex should own `TASK-034` desktop navigation and `TASK-037` JSD app/data decision.
