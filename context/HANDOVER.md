...
1. Run `TASK-056` and `TASK-057` after the new experience stabilizes, using `context/plans/tasks-056-057-simplification-readiness-implementation-plan.md`. Keep JSD panel-only and do not reintroduce similarity map arcs.
