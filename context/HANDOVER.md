...
1. Execute `TASK-055` in the approved direction, then run `TASK-056` and `TASK-057` after the new experience stabilizes. Do not retain guided JSD or map arcs merely because they exist in the baseline.
