...
The repository is a context-first GIS/data-science project. `TASK-001` through `TASK-094`, TASK-096 through TASK-099, and TASK-101 through TASK-105 are complete. On 2026-07-23 the owner approved TASK-090's Night Watch contract, TASK-091 established its budget-neutral surface foundation, TASK-092 carried the hierarchy through the guided story, TASK-093 completed the Explorer treatment while deleting the old glow machinery, and TASK-094 passed the integrated responsive/accessibility refinement. Frozen-production TASK-095 has passed automated and independent QA and remains `in-review` for owner visual/interaction acceptance. The owner-approved inline regional lens is implemented and independently approved. The completed QA-remediation batch corrected source/copy, map-failure, live-breakpoint, and number-format defects without changing the accepted story, palette, marks, data meaning, routes, renderer, or dependencies. TASK-105 adds the independently accepted static Night Watch waves favicon with exact-geometry regression coverage and no runtime or application redesign. TASK-100 now waits only for TASK-095 owner acceptance. `TASK-057` repaired the earlier release findings and passed independent review. No deployment/submission readiness is claimed.
...
1. Have the owner complete TASK-095's live visual/interaction review; if accepted, record `in-review -> done` without rewriting its frozen evidence package.
2. Keep TASK-097 through TASK-099 and TASK-101 through TASK-104 frozen; their implementations and independent reviews are complete.
3. After TASK-095 closes, run TASK-100 frozen independent and owner QA.
...
5. Keep completed TASK-105 frozen as one static public asset and document-head link; do not widen it into a logo system, manifest, React component, dependency, or UI redesign.
