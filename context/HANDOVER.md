...
1. Complete and independently review TASK-119's bounded failure-state clearance repair.
2. Run TASK-110 attempt 3 with a fresh affected frame and auditable case-level interaction/accessibility evidence, then obtain owner visual/interaction acceptance. Keep TASK-095's separate owner gate outstanding.
3. Begin TASK-100 only after TASK-095 and TASK-110 close. Treat deployment, public-URL durability, final disclosure, and submission-form actions as a separate release decision after TASK-100.
4. Only after the held TASK-110/TASK-100 release gates, begin bounded TASK-118 through the existing header/panel/`handleSelect` seams. TASK-117's prototypes are design evidence, not runtime assets.
