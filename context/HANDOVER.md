...
1. Execute `TASK-051` through `TASK-055` in dependency order, one reviewed commit per task, using the approved `context/design-concepts/task-049-concept-review.md` direction. Do not retain guided JSD or map arcs merely because they exist in the baseline.
