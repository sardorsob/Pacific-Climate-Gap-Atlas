...
The repository is a context-first GIS/data-science project. `TASK-001` through `TASK-094`, `TASK-096` through `TASK-109`, `TASK-111` through `TASK-113`, and `TASK-115` are complete. TASK-114, TASK-116, and design-only TASK-117 are back in scoped independent batch review after bounded final-audit corrections; their production/content/design direction is unchanged. Frozen-production TASK-095 has passed automated and independent QA and remains `in-review` for owner visual/interaction acceptance. The inline regional lens now includes the accepted selected reading, evidence-entry hierarchy, correct continuous water/renewable inspectors, a six-group visibility tally, informational-only peer detail, distinct inspection grammar, and at least 44.37px interaction bands at the 320px floor. TASK-110 remains `needs-fix` until its owner gate is rerun against that final lens. TASK-100 and TASK-110 are held for the owner's return. Design-only TASK-117 has independently accepted one visible **Places** disclosure using the existing panel; TASK-118 is a pending post-QA implementation successor. No deployment/submission readiness is claimed.
...
1. Obtain the scoped independent batch re-review for TASK-114's non-production derivation fixture/singular copy, TASK-116's real 844x390 sticky-chrome clearance, and TASK-117's corrected execution-order record.
2. When the owner returns, restart TASK-110 attempt 2 against the final TASK-114/TASK-115 selected panel and obtain owner visual/interaction acceptance. Keep TASK-095's separate owner gate outstanding.
3. Begin TASK-100 only after TASK-095, TASK-110, and TASK-116 close. Treat deployment, public-URL durability, final disclosure, and submission-form actions as a separate release decision after TASK-100.
