...
1. Start `TASK-046` next: decide whether the guided tour should open closer to the data-silence thesis and whether JSD stays in the guided spine.
2. Only after `TASK-046`, use `TASK-047` to decide whether selected-only JSD neighbor arcs add enough story value to justify more map complexity.
